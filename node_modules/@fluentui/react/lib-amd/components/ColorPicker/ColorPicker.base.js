define(["require", "exports", "tslib", "react", "../../Utilities", "../../TextField", "../../Tooltip", "../../common/DirectionalHint", "./ColorRectangle/ColorRectangle", "./ColorSlider/ColorSlider", "../../utilities/color/consts", "../../utilities/color/getColorFromString", "../../utilities/color/getColorFromRGBA", "../../utilities/color/clamp", "../../utilities/color/updateA", "../../utilities/color/updateT", "../../utilities/color/updateH", "../../utilities/color/correctRGB", "../../utilities/color/correctHex", "./ColorRectangle/ColorRectangle.base"], function (require, exports, tslib_1, React, Utilities_1, TextField_1, Tooltip_1, DirectionalHint_1, ColorRectangle_1, ColorSlider_1, consts_1, getColorFromString_1, getColorFromRGBA_1, clamp_1, updateA_1, updateT_1, updateH_1, correctRGB_1, correctHex_1, ColorRectangle_base_1) {
     ...
     */
    var ColorPickerBase = exports.ColorPickerBase = /** @class */ (function (_super) {
        ...
        function ColorPickerBase(props) {
            ...
            _this._onBlur = function (event) {
                var _a, _b;
                var color = (_a = _this.state, _a.color), editingColor = _a.editingColor;
                if (!editingColor) {
                    return;
                }
                ...
                if (value.length >= minLength && (isHex || !isNaN(Number(value)))) {
                    ...
                    if (isHex) {
                        ...
                        newColor = (0, getColorFromRGBA_1.getColorFromRGBA)((0, correctRGB_1.correctRGB)(tslib_1.__assign(tslib_1.__assign({}, color), (_b = {}, _b[component] = Number(value), _b))));
                    }
        ...
        ColorPickerBase.prototype.render = function () {
            ...
            // eslint-disable-next-line deprecation/deprecation
            alphaSliderHidden = (_a = props.alphaSliderHidden, _a === void 0 ? alphaType === 'none' : _a), tooltipProps = props.tooltipProps;
        ...
        ColorPickerBase.prototype._getDisplayValue = function (component) {
            var _a;
            var color = (_a = this.state, _a.color), editingColor = _a.editingColor;
