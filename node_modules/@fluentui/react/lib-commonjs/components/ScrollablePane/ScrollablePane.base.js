...
var ScrollablePaneBase = exports.ScrollablePaneBase = /** @class */ (function (_super) {
    ...
    function ScrollablePaneBase(props) {
        ...
        _this.updateStickyRefHeights = function () {
            ...
            stickyItems.forEach(function (sticky) {
                var _a;
                var isStickyTop = (_a = sticky.state, _a.isStickyTop), isStickyBottom = _a.isStickyBottom;
    ...
    ScrollablePaneBase.prototype.render = function () {
        var _a, _b;
        var className = (_a = this.props, _a.className), scrollContainerFocus = _a.scrollContainerFocus, scrollContainerAriaLabel = _a.scrollContainerAriaLabel, theme = _a.theme, styles = _a.styles, onScroll = _a.onScroll;
        var stickyTopHeight = (_b = this.state, _b.stickyTopHeight), stickyBottomHeight = _b.stickyBottomHeight;
